...
!(function (V) {
    ...
    (m = /Android/.test(se)),
        (a = (a = !(i = /WebKit/.test(se)) && /MSIE/gi.test(se) && /Explorer/gi.test(ue.appName)) && /MSIE (\w+)\./.exec(se)[1]),
    ...
    var le,
        ...
        Ne = function (e, t) {
            ...
            return (
                ...
                }) == ((r = o).isDefaultPrevented === Ce || r.isDefaultPrevented === be) && ((o.isDefaultPrevented = be), (o.isPropagationStopped = be), (o.isImmediatePropagationStopped = be)),
                            ...
                            y.domLoaded && "ready" === u && "complete" === e.readyState
                                ...
                                ((l = !0),
                                    ...
                                    (i = b[o][u])
                                        ...
                                        : ((b[o][u] = i = [{ func: n, scope: r }]), (i.fakeName = s), (i.capture = l), (i.nativeHandler = c), "ready" === u ? Ee(e, c, y) : xe(e, s || u, c, l)));
                    return (e = i = 0), n;
                }
            }),
    ...
    for (Te in ((ke = St.support = {}),
                ...
                (n.addEventListener
                    ...
                    (Je = t
                        ? function (e, t) {
                            ...
                            return (
                                n ||
                                (1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || (!ke.sortDetached && t.compareDocumentPosition(e) === n)
        ...
        (St.matchesSelector = function (e, t) {
            if (((e.ownerDocument || e) !== Me && Fe(e), (t = t.replace(mt, "='$1']")), ke.matchesSelector && Ue && (!Ve || !Ve.test(t)) && (!je || !je.test(t))))
                try {
            ...
            preFilter: {
                ...
                PSEUDO: function (e) {
                    ...
                    return ht.CHILD.test(e[0])
                        ? null
                        : (e[3] ? (e[2] = e[4] || e[5] || "") : n && gt.test(n) && (t = De(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && ((e[0] = e[0].slice(0, t)), (e[2] = n.slice(0, t))), e.slice(0, 3));
                },
            },
            filter: {
                TAG: function (e) {
                    ...
                    return 1 === g && 0 === p
                        ...
                        : function (e, t, n) {
                            ...
                            if (l) {
                                ...
                                else for (; (i = (++u && i && i[c]) || (a = u = 0) || s.pop()) && ((y ? i.nodeName.toLowerCase() !== f : 1 !== i.nodeType) || !++a || (d && ((i[qe] || (i[qe] = {}))[m] = [We, a]), i !== e)); );
        ...
        (De = St.tokenize = function (e, t) {
            ...
            for (a = e, u = [], s = _e.preFilter; a; ) {
                for (i in ((n && !(r = ft.exec(a))) || (r && (a = a.slice(r[0].length) || a), u.push((o = []))),
                    (n = !1),
                (r = dt.exec(a)) && ((n = r.shift()), o.push({ value: n, type: r[0].replace(lt, " ") }), (a = a.slice(n.length))),
                    _e.filter))
                    !(r = ht[i].exec(a)) || (s[i] && !(r = s[i](r))) || ((n = r.shift()), o.push({ value: n, type: i, matches: r }), (a = a.slice(n.length)));
                if (!n) break;
            }
    ...
    (gn.fn = gn.prototype = {
        ...
        add: function (e, t) {
            ...
            if (!1 !== t) for (n = gn.unique(o.toArray().concat(gn.makeArray(e))), o.length = n.length, r = 0; r < n.length; r++) o[r] = n[r];
            ...
            function (r, o) {
                gn.fn[r] = function (t, e) {
                    ...
                    return (
                        ...
                        1 < this.length && ((n = gn.unique(n)), (0 !== r.indexOf("parents") && "prevUntil" !== r) || (n = n.reverse())),
                            (n = gn(n)),
                            e ? n.filter(e) : n
                    );
                };
    ...
    var En,
        ...
        Fn = function (e) {
            var t = e.current;
            return { current: t, version: e.version, isEdge: Ln("Edge", t), isChrome: Ln("Chrome", t), isIE: Ln("IE", t), isOpera: Ln("Opera", t), isFirefox: Ln(In, t), isSafari: Ln("Safari", t) };
        },
        Mn = {
            unknown: function () {
        ...
        qn = function (e) {
            var t = e.current;
            return { current: t, version: e.version, isWindows: Hn(zn, t), isiOS: Hn("iOS", t), isAndroid: Hn(Un, t), isOSX: Hn("OSX", t), isLinux: Hn("Linux", t), isSolaris: Hn(jn, t), isFreeBSD: Hn(Vn, t) };
        },
        $n = {
            unknown: function () {
            ...
            return {
                ...
                deviceType:
                    ((n = g),
                        ...
                        { isiPad: q(o), isiPhone: q(i), isTablet: q(s), isPhone: q(l), isTouch: q(c), isAndroid: t.isAndroid, isiOS: t.isiOS, isWebView: q(f) }),
            };
        },
        or = {
            detect:
            ...
            decode: function (e) {
                return e.replace(Yo, function (e, t) {
                    return t
                        ...
                        : vo[e] || po[e] || ((n = e), ((r = ar.fromTag("div").dom()).innerHTML = n), r.textContent || r.innerText || n);
                    var n, r;
                });
            },
        },
        ...
        li = function (e) {
            var u,
                ...
                a = function (e, t, n) {
                    ...
                    for (t = t || "", "string" == typeof (n = n || []) && (n = ci(n)), r = (e = ci(e)).length; r--; ) (i = { attributes: a((o = ci([u, t].join(" ")))), attributesOrder: o, children: a(n, ri) }), (s[e[r]] = i);
                },
                c = function (e, t) {
                    var n, r, o, i;
    ...
    function di(i) {
        ...
        return (
            i.valid_elements
                ...
                x("+ol[ul|ol],+ul[ul|ol]"),
                ii({ dd: "dl", dt: "dl", li: "ul ol", td: "tr", th: "tr", tr: "tbody thead tfoot", tbody: "table", thead: "table", tfoot: "table", legend: "fieldset", area: "map", param: "video audio object" }, function (e, t) {
    ...
    var ea,
        ...
        Wa = Math.round,
        Ka = function (e) {
            return e ? { left: Wa(e.left), top: Wa(e.top), bottom: Wa(e.bottom), right: Wa(e.right), width: Wa(e.width), height: Wa(e.height) } : { left: 0, top: 0, bottom: 0, right: 0, width: 0, height: 0 };
        },
        Xa = function (e, t) {
        ...
        wu = function (e) {
            ...
            return (
                (t = 0 < (n = e.getClientRects()).length ? Ka(n[0]) : Ka(e.getBoundingClientRect())),
                    !bu(e) && gu(e) && xu(t)
                        ? ((i = (r = e).ownerDocument), (a = vu(i)), (u = i.createTextNode("\xa0")), (s = r.parentNode).insertBefore(u, r), a.setStart(u, 0), a.setEnd(u, 1), (o = Ka(a.getBoundingClientRect())), s.removeChild(u), o)
                        : xu(t) && bu(e)
                        ? (function (e) {
                            var t = e.startContainer,
                                n = e.endContainer,
    ...
    var Tu,
        ...
        Hu = function (e, t) {
            ...
            (n = e[i + "Container"]),
                (r = e[i + "Offset"]),
            jo.isElement(n) && "TR" === n.nodeName && (n = (o = n.childNodes)[Math.min(t ? r : r - 1, o.length - 1)]) && ((r = t ? 0 : n.childNodes.length), e["set" + (t ? "Start" : "End")](n, r));
        },
        qu = function (e) {
        ...
        Yu = {
            getBookmark: function (e, t, n) {
                return 2 === t ? Wu(wa, n, e) : 3 === t ? ((o = (r = e).getRng()), { start: Lu(r.dom.getRoot(), _u.fromRangeStart(o)), end: Lu(r.dom.getRoot(), _u.fromRangeEnd(o)) }) : t ? { rng: e.getRng() } : Xu(e, !1);
                var r, o;
            },
    ...
    var Ms,
        ...
        Gs = function (e, t, n) {
            ...
            if (Vs(f)) {
                ...
                if (xs(e) && d < f.childNodes.length && ((o = Xs(f, d)), $s(o)))
                    return qs(o)
                        ? ((s = n), (l = (c = o).nextSibling) && $s(l) ? (Vs(l) ? _u(l, 0) : _u.before(l)) : Gs(Tu.Forwards, _u.after(c), s))
                        : !Ws(o) && (i = Es(o, e, Ks, o))
                            ? Vs(i)
                                ? _u(i, 0)
                                : _u.before(i)
        ...
        pc = function (e, t) {
            ...
            if (t) {
                ...
                if ("string" == typeof t.start)
                    return _.some(((f = t), (d = (l = y).createRng()), (m = Fu(l.getRoot(), f.start)), d.setStart(m.container(), m.offset()), (m = Fu(l.getRoot(), f.end)), d.setEnd(m.container(), m.offset()), d));
        ...
        Pc = function (e, t, n, r) {
            ...
            return (
                ...
                1 === u.nodeType && u.hasChildNodes() && 3 === (u = eu(u, t.collapsed ? s : s - 1)).nodeType && (s = u.nodeValue.length),
                    (i = _c(c, i)),
                    (u = _c(c, u)),
                (Nc(i.parentNode) || Nc(i)) && ((i = Nc(i) ? i : i.parentNode), 3 === (i = t.collapsed ? i.previousSibling || i : i.nextSibling || i).nodeType && (a = t.collapsed ? i.length : 0)),
                (Nc(u.parentNode) || Nc(u)) && ((u = Nc(u) ? u : u.parentNode), 3 === (u = t.collapsed ? u.nextSibling || u : u.previousSibling || u).nodeType && (s = t.collapsed ? 0 : u.length)),
                t.collapsed && ((o = Rc(c, e.getBody(), i, a, !0, r)) && ((i = o.container), (a = o.offset)), (o = Rc(c, e.getBody(), u, s, !1, r)) && ((u = o.container), (s = o.offset))),
                n[0].inline &&
                (u = r
                    ? u
                    : (function (e, t) {
                ...
                (n[0].inline || n[0].block_expand) && ((n[0].inline && 3 === i.nodeType && 0 !== a) || (i = Bc(c, n, i, a, u, s, !0)), (n[0].inline && 3 === u.nodeType && s !== u.nodeValue.length) || (u = Bc(c, n, i, a, u, s, !1))),
                n[0].selector && !1 !== n[0].expand && !n[0].inline && ((i = Dc(c, n, t, i, "previousSibling")), (u = Dc(c, n, t, u, "nextSibling"))),
                (n[0].block || n[0].selector) && ((i = Oc(e, n, i, "previousSibling")), (u = Oc(e, n, u, "nextSibling")), n[0].block && (c.isBlock(i) || (i = Bc(c, n, i, a, u, s, !0)), c.isBlock(u) || (u = Bc(c, n, i, a, u, s, !1)))),
        ...
        Vc = function (s, c, l, f) {
            s.undoManager.transact(function () {
                ...
                if (
                    (o.collapsed &&
                    ((r = Pc((e = s), (t = o), [{ inline: !0 }], 3 === (n = t).startContainer.nodeType && n.startContainer.nodeValue.length >= n.startOffset && "\xa0" === n.startContainer.nodeValue[n.startOffset])),
    ...
    var ul,
        ...
        fl = function (e, t) {
            var n,
                ...
                i = o.startContainer,
                a = o.startOffset;
            o.collapsed && ((n = i), (r = a), jo.isText(n) && "\xa0" === n.nodeValue[r - 1]) && jo.isText(i) && (i.insertData(a - 1, " "), i.deleteData(a, 1), o.setStart(i, a), o.setEnd(i, a), e.selection.setRng(o)),
        ...
        dl = function (e, t, n) {
            ...
            if (
                ...
                (e.selection.setRng(cl(e.selection.getRng())),
                    ...
                    (C = y.startContainer),
                    (x = y.startOffset),
                3 === C.nodeType && y.collapsed && ("\xa0" === C.data[x] ? (C.deleteData(x, 1), /[\u00a0| ]$/.test(b) || (b += " ")) : "\xa0" === C.data[x - 1] && (C.deleteData(x - 1, 1), /[\u00a0| ]$/.test(b) || (b = " " + b))),
                    (t = b));
                var E,
                    S,
                    T,
                    ...
                    (function (n, e) {
                        ...
                        if (e) {
                            ...
                            (i = e.previousSibling) && 3 === i.nodeType
                                ? (c.setStart(i, i.nodeValue.length), fe.ie || ((a = e.nextSibling) && 3 === a.nodeType && (i.appendData(a.data), a.parentNode.removeChild(a))))
        ...
        ml = function (e, t) {
            var n,
                r,
                o = "string" != typeof (n = t) ? ((r = Xt.extend({ paste: n.paste, data: { paste: n.paste } }, n)), { content: n.content, details: r }) : { content: n, details: {} };
            ...
            return ru(t, n, Zl).filter(function (e) {
                return (
                    ...
                    Vr((n = e).from().block())
                        ...
                        .isSome() &&
                    ((t = e), !1 === jo.isContentEditableFalse(t.from().block().dom()) && !1 === jo.isContentEditableFalse(t.to().block().dom()))
                );
                var t, n, r;
            });
        },
            ...
            return (
                (i = e),
                    ...
                    jo.isElement(a) && a.getAttribute("data-mce-caret") === u
                        ? ((t = e),
                            (n = o.getNode(!1 === e)),
                            t && jo.isContentEditableFalse(n.nextSibling) ? _.some(jf.moveToElement(n.nextSibling)) : !1 === t && jo.isContentEditableFalse(n.previousSibling) ? _.some(jf.moveToElement(n.previousSibling)) : _.none()).fold(
                        function () {
                            return Hf(r, e, o);
                        },
                        _.some
        ...
        Um = function (e) {
            ...
            return (
                t === r && jo.isText(t)
                    ? 0 < n && n < t.nodeValue.length && ((t = (r = zm(t, n)).previousSibling), n < o ? ((t = r = zm(r, (o -= n)).previousSibling), (o = r.nodeValue.length), (n = 0)) : (o = 0))
                    : (jo.isText(t) && 0 < n && n < t.nodeValue.length && ((t = zm(t, n)), (n = 0)), jo.isText(r) && 0 < o && o < r.nodeValue.length && (o = (r = zm(r, o).previousSibling).nodeValue.length)),
        ...
        dp(this, {
            execCommand: function (t, n, r, e) {
                var o,
                    ...
                    a = !1;
                if (!s.removed) {
                    if ((/^(mceAddUndoLevel|mceEndUndoLevel|mceBeginUndoLevel|mceRepaint)$/.test(t) || (e && e.skip_focus) ? ap(s) : s.focus(), (e = s.fire("BeforeExecCommand", { command: t, ui: n, value: r })).isDefaultPrevented()))
                        return !1;
    ...
    var yp,
        ...
        Rp = function (e, t) {
            Ap(ar.fromDom(e.getBody()), "mce-content-readonly", t),
                t
                    ...
                    : ((e.readonly = !1), (e.getBody().contentEditable = "true"), _p(e, "StyleWithCSS", !1), _p(e, "enableInlineTableEditing", !1), _p(e, "enableObjectResizing", !1), e.focus(), e.nodeChanged());
        },
        Dp = function (e) {
        ...
        Lp = {
            ...
            toggleNativeEvent: function (e, t) {
                ...
                "focus" !== e &&
                "blur" !== e &&
                (t ? (n.initialized ? Ip(n, e) : n._pendingNativeEvents ? n._pendingNativeEvents.push(e) : (n._pendingNativeEvents = [e])) : n.initialized && (n.dom.unbind(Bp(n, e), e, n.delegates[e]), delete n.delegates[e]));
            },
    ...
    function Qp(i) {
        var a = {},
            ...
            s = function (e, t, n, r) {
                var o;
                return ((o = Xt.map(Yp(e, ">"), u))[o.length - 1] = Xt.extend(o[o.length - 1], { func: n, scope: r || i })), Xt.extend(o[0], { desc: i.translate(t), subpatterns: o.slice(1) });
            },
            o = function (e, t) {
    ...
    function qh(u) {
        var n,
                        ...
                        return (
                            (t = e.id || Hh.uuid("blobid")),
                                (n = e.name || t),
                                {
                                    id: q(t),
                                    name: q(n),
                                    filename: q(n + "." + ((r = e.blob.type), { "image/jpeg": "jpg", "image/jpg": "jpg", "image/gif": "gif", "image/png": "png" }[r.toLowerCase()] || "dat")),
                                    blob: q(e.blob),
                                    base64: q(e.base64),
            ...
            y = function (e, t) {
                l.removeByUri(e.src), h(e.src, t), u.$(e).attr({ src: Bl(u) ? t + "?" + new Date().getTime() : t, "data-mce-src": u.convertURL(t, "src") });
            },
            b = function (n) {
                return (
                                        ...
                                        i.upload(e, v).then(
                                            m(function (e) {
                                                var t = W(e, function (e, t) {
                                                    var n = r[t].image;
                                                    return e.status && Pl(u) ? y(n, e.url) : e.error && kh.uploadError(u, e.error), { element: n, status: e.status };
                                                });
                                                return n && n(t), t;
                                            })
                                        )
    ...
    var $h = function (e, t) {
        ...
        Jh = function (o, e) {
            return ru(
                ((i = e), (a = i.startContainer), (u = i.startOffset), jo.isText(a) ? (0 === u ? _.some(ar.fromDom(a)) : _.none()) : _.from(a.childNodes[u]).map(ar.fromDom)),
                ((t = e), (n = t.endContainer), (r = t.endOffset), jo.isText(n) ? (r === n.data.length ? _.some(ar.fromDom(n)) : _.none()) : _.from(n.childNodes[r - 1]).map(ar.fromDom)),
                function (e, t) {
                    var n = X(Yh(o), d(Mr, e)),
                        r = X(Gh(o), d(Mr, t));
                ...
                l = function (e, t) {
                    ...
                    return (
                        (i = e.startContainer),
                            (a = e.startOffset),
                            (u = e.endOffset),
                        3 === i.nodeType && 0 === a && Dv(i.parentNode) && ((i = i.parentNode), (a = m.nodeIndex(i)), (i = i.parentNode)),
                            1 !== i.nodeType
                                ? null
                ...
                for (
                    ...
                    if ((R < t.index && H(B(e.substr(R, t.index - R))), (n = t[6]))) ":" === (n = n.toLowerCase()).charAt(0) && (n = n.substr(1)), L(n);
                        ...
                        if (!p || (l = U.getElementRule(n))) {
                            if (
                                ((f = !0), p && ((y = l.attributes), (b = l.attributePatterns)), (v = t[8]) ? ((m = -1 !== v.indexOf("data-mce-type")) && u && (f = !1), ((d = []).map = {}), v.replace(T, F)) : ((d = []).map = {}), p && !m)
                            ) {
                                ...
                                if (x) for (o = x.length; o--; ) (a = (h = x[o]).name) in d.map || ("{$uid}" === (_ = h.value) && (_ = "mce_" + O++), (d.map[a] = _), d.push({ name: a, value: _ }));
                                if (C) {
                        ...
                        (n = t[1])
                            ? (">" === n.charAt(0) && (n = " " + n), z.allow_conditional_comments || "[if" !== n.substr(0, 3).toLowerCase() || (n = " " + n), j(n))
                            : (n = t[2])
                            ? V(Pv(n))
                            : (n = t[3])
                                ? K(n)
        ...
        return (
            u.on("init", function () {
                ...
                u.on("KeyUp", function (e) {
                    ...
                    r && o.typing && !1 === ny(ey(u), l[0]) && (!1 === u.isDirty() && (d(!0), u.fire("change", { level: l[0], lastLevel: null })), u.fire("TypingUndo"), (r = !1), u.nodeChanged()));
                }),
    ...
    var cy = function (e, t) {
        ...
        yy = function (e, n, r, o, i) {
            ...
            return "none" !== n.remove
                ...
                (y
                    ...
                    : v.isBlock(m) && !v.isBlock(h) && (vy(v, m, !1) || vy(v, m.firstChild, !0, 1) || m.insertBefore(v.create("br"), m.firstChild), vy(v, m, !0) || vy(v, m.lastChild, !1, 1) || m.appendChild(v.create("br")))),
        ...
        Cy = function (s, c, l, e, f) {
            var t,
                ...
                p = function (e) {
                    ...
                    return (
                        yc((t = r)) && jo.isElement(t) && ("_start" === t.id || "_end" === t.id) && (r = r[e ? "firstChild" : "lastChild"]),
                        jo.isText(r) && 0 === r.data.length && (r = e ? n.previousSibling || n.nextSibling : n.nextSibling || n.previousSibling),
                            u.remove(n, !0),
                            r
                    );
                },
            ...
            if (e) e.nodeType ? ((n = u.createRng()).setStartBefore(e), n.setEndAfter(e), o(n)) : o(e);
                ...
                r.isCollapsed() && m.inline && !u.select("td[data-mce-selected],th[data-mce-selected]").length
                    ...
                    : ((t = Yu.getPersistentBookmark(s.selection, !0)), o(r.getRng()), r.moveToBookmark(t), m.inline && Mm.match(s, c, l, r.getStart()) && wc.moveStart(u, r, r.getRng()), s.nodeChanged());
            else {
                e = r.getNode();
        ...
        Ay = function (e, t) {
            ...
            ((n = wc.getTextDecoration(e, t.parentNode)), e.getStyle(t, "color") && n ? e.setStyle(t, "text-decoration", n) : e.getStyle(t, "text-decoration") === n && e.setStyle(t, "text-decoration", null));
        },
        Ry = function (n, e, r, o) {
            xy(e, function (t) {
                            ...
                            var a,
                                u = function (e) {
                                    ...
                                    if (y.wrapper && Mm.matchNode(g, e, p, h)) a = 0;
                                        ...
                                        !m || r || !wc.isValid(g, l, t) || !wc.isValid(g, n, l) || (!c && 3 === e.nodeType && 1 === e.nodeValue.length && 65279 === e.nodeValue.charCodeAt(0)) || Ju(e) || (y.inline && s.isBlock(e))
                        ...
                        Ly(d, function (e) {
                            ...
                            (n = 0),
                                ...
                                (!(1 < d.length) && s.isBlock(e)) || 0 !== t
                                    ? (y.inline || y.wrapper) &&
                                    (y.exact || 1 !== t || ((o = a((r = e))) && !yc(o) && Mm.matchName(s, o, y) && ((i = s.clone(o, !1)), b(i), s.replace(i, r, !0), s.remove(o, 1)), (e = i || r)),
                                        Ry(g, v, h, e),
                                        Iy(g, y, p, h, e),
                                        Oy(s, y, h, e),
                                        By(s, y, h, e),
                    ...
                    if (r) r.nodeType ? C(v, r) || ((t = i.createRng()).setStartBefore(r), t.setEndAfter(r), a(i, Pc(g, t, v), 0, !0)) : a(i, r, 0, !0);
                        ...
                        !(function (e, t, n) {
                            ...
                            s && 0 < a && a < s.length && d.test(s.charAt(a)) && d.test(s.charAt(a - 1))
                                ? ((u = c.getBookmark()), r.collapse(!0), (r = Pc(e, r, e.formatter.get(t))), (r = Um(r)), e.formatter.apply(t, n, r), c.moveToBookmark(u))
                                : ((o && i.nodeValue === jm) || ((l = e.getDoc()), (f = $m(!0).dom()), (i = (o = l.importNode(f, !0)).firstChild), r.insertNode(o), (a = 1)), e.formatter.apply(t, n, o), c.setCursorLocation(i, a));
                        })(g, p, h);
                    else {
        ...
        qy = function (e, t) {
            var n,
                ...
                g = function (e) {
                    var t, n, r;
                    return (o = "string" == typeof e ? { name: e, classes: [], attrs: {} } : e), (t = Hy.create(o.name)), (n = t), (r = o).classes.length && Hy.addClass(n, r.classes.join(" ")), Hy.setAttribs(n, r.attrs), t;
                },
                p = function (n, e, t) {
                    var r,
                        o,
                        ...
                        f = 0 < e.length && e[0],
                        d = f && f.name;
                    if (((u = d), (s = "string" != typeof (a = n) ? a.nodeName.toLowerCase() : a), (c = m.getElementRule(s)), (i = !(!(l = c && c.parentsRequired) || !l.length) && (u && -1 !== Xt.inArray(l, u) ? u : l[0]))))
        ...
        Ky = function (n, e) {
            ...
            return "preview" in e && !1 === (u = e.preview)
                ...
                : ((t = e.block || e.inline || "span"),
                    (i = Wy(e.selector)).length ? (i[0].name || (i[0].name = t), (t = e.selector), (r = qy(i, n))) : (r = qy([t], n)),
                    ...
                    Vy(u.split(" "), function (e) {
                        ...
                        if (
                            !(
                                ("background-color" === e && /transparent|rgba\s*\([^)]+,\s*0\)/.test(t) && ((t = Hy.getStyle(n.getBody(), e, !0)), "#ffffff" === Hy.toHex(t).toLowerCase())) ||
            ...
            var R = function (e) {
                ...
                B = function (e) {
                    ...
                    (t = e.screenX - d),
                        ...
                        (b = b < 5 ? 5 : b),
                        (C = C < 5 ? 5 : C),
                    (R(u) && !1 !== a.settings.resize_img_proportional ? !rv.modifierPressed(e) : rv.modifierPressed(e) || (R(u) && f[2] * f[3] != 0)) &&
                        ...
                        O(e) && !n.isDefaultPrevented()
                            ? E(l, function (n, e) {
                                ...
                                (t = N.get("mceResizeHandle" + e)) && N.remove(t),
                                    (t = N.add(A, "div", { id: "mceResizeHandle" + e, "data-mce-bogus": "all", class: "mce-resizehandle", unselectable: !0, style: "cursor:" + e + "-resize; margin:0; padding:0" })),
                                11 === fe.ie && (t.contentEditable = !1),
                                    N.bind(t, "mousedown", function (e) {
                                        ...
                                        T !== S && (N.bind(T, "mousemove", B), N.bind(T, "mouseup", P)),
                                            (c = N.add(A, "div", { class: "mce-resize-helper", "data-mce-bogus": "all" }, h + " &times; " + v));
                                    }),
                                    (n.elm = t),
                ...
                L = function (e) {
                    ...
                    (E(N.select("img[data-mce-selected],hr[data-mce-selected]"), function (e) {
                        ...
                        n((t = N.$(t).closest("table,img,figure.image,hr")[0]), A) && (z(), n(r.getStart(!0), t) && n(r.getEnd(!0), t)) ? o(t) : I());
                },
                F = function (e) {
                    return Ab(
                        (function (e, t) {
                        ...
                        s.startContainer === c && s.endContainer === c
                            ...
                            : (s.deleteContents(),
                                0 === c.body.childNodes.length
                                    ...
                                    : ((i = c.createDocumentFragment()), (a = c.createElement("div")), i.appendChild(a), (a.outerHTML = t), s.insertNode(i))),
                        (o = e.dom.get("__caret")),
                            ...
                            (e = c.getBody()),
                                (t = m())
                                    ? ((r = t.startContainer),
                                        ...
                                        3 === r.nodeType && 3 === o.nodeType && ((r = r.length === i ? rC(r.nextSibling, !0) : r.parentNode), (o = 0 === a ? rC(o.previousSibling, !1) : o.parentNode), r && r === o))
                                            ? r
                                            : n && 3 === n.nodeType
                                            ? n.parentNode
                                            : n)
    ...
    var sC = function (e, t) {
        ...
        CC = function (e, t, n, r) {
            ...
            if (((d = yC(r)), (o = Ps(e, t.getBody(), r)), (i = n(t.getBody(), sv(1), o)), (a = U(i, cv(1))), (s = Ht.last(o.getClientRects())), (Lf(o) || zf(o)) && (d = o.getNode()), (Ff(o) || Uf(o)) && (d = o.getNode(!0)), !s))
                return null;
        ...
        xC = function (e, t, n) {
            ...
            if (n.collapsed && e.settings.forced_root_block) {
                ...
                ((a = (i = e).dom.create(Nl(i))), (!fe.ie || 11 <= fe.ie) && (a.innerHTML = '<br data-mce-bogus="1">'), (o = a), 1 === t ? e.$(r).after(o) : e.$(r).before(o), e.selection.select(o, !0), e.selection.collapse());
            }
        },
        wC = function (l, f) {
            return function () {
                ...
                l = U(
                    ((i = e),
                        G(c, function (e) {
                            var t,
                                n,
                                r = ((t = Ka(e.getBoundingClientRect())), (n = -1), { left: t.left - n, top: t.top - n, right: t.right + 2 * n, bottom: t.bottom + 2 * n, width: t.width + n, height: t.height + n });
                            return [
        ...
        RC = function (e, t, n) {
            var r,
                ...
                a,
                u = e(t, n);
            return ((a = u).breakType === Tb.Wrap && 0 === a.positions.length) || (!jo.isBr(n.getNode()) && (i = u).breakType === Tb.Br && 1 === i.positions.length)
                ? ((r = e),
                    (o = t),
                    !u.breakAt
                        .map(function (e) {
        ...
        px = function (a, e) {
            ...
            Dg(x, E).each(function (e) {
                ...
                (m = Nl(a)),
                (n = e.shiftKey),
            jo.isElement(s) && s.hasChildNodes() && ((g = i > s.childNodes.length - 1), (s = s.childNodes[Math.min(i, s.childNodes.length - 1)] || s), (i = g && jo.isText(s) ? s.nodeValue.length : 0)),
            (u = dx(x, s)) &&
            (((m && !n) || (!m && n)) &&
                    ...
                    ((m = m || "P"),
                        Sa(c)
                            ...
                            : T(!0)
                                ...
                                : ((t = ((b = E), (C = b.cloneRange()), C.setStart(b.startContainer, fx(!0, b.startContainer, b.startOffset)), C.setEnd(b.endContainer, fx(!1, b.endContainer, b.endOffset)), C).cloneRange()).setEndAfter(c),
                                    (o = t.extractContents()),
                                    (y = o),
                ...
                .bind(function (e) {
                    ...
                    return (
                        (i = l),
                            (u = (a = c).data),
                            (s = Su(a, 0)),
                            (Qx(u, 0) && !Jx(i, s) && ((a.data = " " + u.slice(1)), 1)) || ew(c) || ((t = l), (r = (n = c).data), (o = Su(n, r.length - 1)), Qx(r, r.length - 1) && !Jx(t, o) && ((n.data = r.slice(0, -1) + " "), 1))
                                ? _.some(e)
                                : _.none()
                    );
                });
    ...
    var gw = function (e) {
        ...
        bw = function (t, e) {
            ...
            t.readonly || (t.inline && "static" === vw.getStyle(n, "position", !0) && (n.style.position = "relative"), (n.contentEditable = t.getParam("content_editable_state", !0))),
                (n.disabled = !1),
                (t.editorUpload = qh(t)),
                (t.schema = di(f)),
                (t.dom = Si(m, {
                ...
                Xh(t),
                t.fire("PreInit"),
            f.browser_spellcheck || f.gecko_spellcheck || ((m.body.spellcheck = !1), vw.setAttrib(n, "spellcheck", "false")),
                (t.quirks = mw(t)),
                t.fire("PostRender"),
        ...
        xw = function (e, t) {
            var n,
                ...
                l = ((n = e.id),
                    ...
                    Tr(s, { width: "100%", height: ((a = o), (u = "number" == typeof a ? a + "px" : a), u || ""), display: "block" }),
                    s).dom();
            l.onload = function () {
        ...
        Aw = function (t) {
            ...
            return (
                (t.rtl = u.rtl_ui || t.editorManager.i18n.rtl),
                    ...
                    S(o) ? ((n.settings.theme = Sw(o)), (r = Ah.get(o)), (n.theme = new r(n, Ah.urls[o])), n.theme.init && n.theme.init(n, Ah.urls[o] || n.documentBaseUrl.replace(/\/$/, ""), n.$)) : (n.theme = {}),
                    (i = t),
                    (a = []),
    ...
    var Uw = function (e, t, n) {
                            ...
                            : ((t = u),
                                ...
                                0 === (r = s).length || /^\s+$/.test(r)
                                    ? ((a = '<br data-mce-bogus="1">'),
                                        ...
                                        (i = Nl(t)) && t.schema.isValidChild(n.nodeName.toLowerCase(), i.toLowerCase()) ? ((r = a), (r = t.dom.createHTML(i, t.settings.forced_root_block_attrs, r))) : r || (r = '<br data-mce-bogus="1">'),
                                        qw(t, r),
                                        t.fire("SetContent", o))
                                    : ("raw" !== o.format && (r = al({ validate: t.validate }, t.schema).serialize(t.parser.parse(r, { isRootContent: !0, insert: !0 }))),
        ...
        Yw = function (e, t) {
            ...
            e.destroyed ||
            (t || e.removed
                ? (t || (e.editorManager.off("beforeunload", e._beforeUnload), e.theme && e.theme.destroy && e.theme.destroy(), Kw(i), Kw(a)),
                (r = (n = e).formElement) && (r._mceOldSubmit && ((r.submit = r._mceOldSubmit), (r._mceOldSubmit = null)), Ww.unbind(r, "submit reset", n.formEventDelegate)),
        ...
        (tN.prototype = {
            ...
            execCallback: function (e) {
                ...
                if (o)
                    return (
                        ...
                        "string" == typeof o && ((r = (r = o.replace(/\.\w+$/, "")) ? Zw(r) : 0), (o = Zw(o)), (this.callbackLookup = this.callbackLookup || {}), (this.callbackLookup[e] = { func: o, scope: r })),
            ...
            hide: function () {
                ...
                (eN && t && !e.inline && t.execCommand("SelectAll"),
                    e.save(),
                    e.inline ? ((e.getBody().contentEditable = !1), e === e.editorManager.focusedEditor && (e.editorManager.focusedEditor = null)) : (Gw.hide(e.getContainer()), Gw.setStyle(e.id, "display", e.orgDisplay)),
                    (e.hidden = !0),
                    e.fire("hide"));
            },
            isHidden: function () {
                            ...
                            (o = gn.unique(
                                (function (t) {
                                    var e,
                                        n = [];
                                    if (fe.ie && fe.ie < 11)
                                        return kh.initError("TinyMCE does not support the browser you are using. For a list of supported browsers please see: https://www.tinymce.com/docs/get-started/system-requirements/"), [];
                                    if (t.types)
                                        return (
                                ...
                                return (
                                    (e = u),
                                        ...
                                        (i = VN((e /= 255), VN((t /= 255), (n /= 255)))) === (a = HN(e, HN(t, n)))
                                            ? { h: 0, s: 0, v: 100 * (o = i) }
                                            : ((r = (a - i) / a), { h: qN(60 * ((e === i ? 3 : n === i ? 1 : 5) - (e === i ? t - n : n === i ? e - t : n - e) / ((o = a) - i))), s: qN(100 * r), v: qN(100 * o) })
                                );
                                var e, t, n, r, o, i, a;
                            }),
                            (n.toHex = function () {
